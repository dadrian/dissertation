...
\if0
% This doesn't apply, even if you had different certificates for different protocol versions, as long as the name matches, it doesn't matter which one is used.
