...
itself~\cite{2013:01:briefChronologyOfSSLTLSAttacks}. Prominent recent
examples include attacks on outdated or deliberately weakened encryption in
RC4~\cite{RC4biases}, RSA~\cite{SMACKTLS}, and Diffie-Hellman~\cite{logjam-2015},
different side channels including Lucky13~\cite{Lucky13}, BEAST~\cite{BEAST},
and POODLE~\cite{POODLE}, and several attacks on invalid TLS protocol
