...
\small
%$$[00\ 00\ 00\ 00\ k\pos{1}\ k\pos{2}\ k\pos{3}\ k\pos{4}\ k\pos{5}\ k\pos{6}\ k\pos{7}\ k\pos{8}\ k\pos{9}\ k\pos{10}\ k\pos{11}\ k\pos{12}]$$
...
% we have named it the "\tOracleSSLclear".
